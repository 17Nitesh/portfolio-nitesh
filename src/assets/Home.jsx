    ...
    return(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  mt-48 font-mono overflow:hidden"  >
            <motion.div className="text-white text-center md:text-right overflow-hidden" variants={headings} initial="initial" animate="animate" >
                <motion.h2 variants = {headings} className="mr-16">Front-End Developer</motion.h2>
                <motion.h2 variants={headings} className="mr-16">Chemical Engineer</motion.h2>
                <motion.h1 variants={headings}className="text-6xl mr-16 mt-2 overflow-hidden"><span className="hover:text-nit-100 hover:text-7xl">Hello</span> <span className="hover:text-nit-100 hover:text-7xl">I'm <br /></span> <span className="text-8xl text-nit-100 hover:text-white hover:text-9xl"><b><Typewriter text="Nitesh" delay={400} infinite /></b></span></motion.h1>
                <motion.p variants={headings} className="ml-10 mr-16 mt-4 font-sans">I am a Chemical Engineering student from IIT Jammu, and served as Head of the Network and Security Department of Coding Club IIT Jammu from August 2023 to August 2024.</motion.p>
